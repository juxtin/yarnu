...
export declare type NavigationState = Readonly<{
    /**
...
export declare type PartialState<State extends NavigationState> = Partial<Omit<State, 'stale' | 'type' | 'key' | 'routes' | 'routeNames'>> & Readonly<{
    stale?: true;
    type?: string;
    routes: (Omit<Route<string>, 'key'> & {
        key?: string;
...
export declare type Route<RouteName extends string> = Readonly<{
    /**
